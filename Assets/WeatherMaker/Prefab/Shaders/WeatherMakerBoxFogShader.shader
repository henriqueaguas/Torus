...
Shader "WeatherMaker/WeatherMakerBoxFogShader"
{
	Properties
	{
		...
		[PerRendererData] _WeatherMakerFogBoxMin("Fog Box Min", Vector) = (0, 0, 0, 0)
		[PerRendererData] _WeatherMakerFogBoxMax("Fog Box Max", Vector) = (10, 10, 10, 0)
		[PerRendererData] _WeatherMakerFogBoxMinDir("Fog Box Min", Vector) = (0, 0, 0, 0)
		[PerRendererData] _WeatherMakerFogBoxMaxDir("Fog Box Max", Vector) = (0, 0, 0, 0)
		...
		[PerRendererData] _WeatherMakerFogBoxCenter("Fog Box Center", Vector) = (0, 0, 0, 0)
		[PerRendererData] _WeatherMakerFogVolumePower("Fog Box Power", Vector) = (0, 0, 0, 0)
