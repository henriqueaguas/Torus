...
*/
float3 computeCameraSpacePosFromDepthAndInvProjMat(v2f i)
{
...
*/
float3 computeCameraSpacePosFromDepthAndVSInfo(v2f i)
{
    float zdepth = SAMPLE_DEPTH_TEXTURE(_CameraDepthTexture, i.uv.xy);
...
float3 computeCameraSpacePosFromDepth(v2f i);
