...
namespace DigitalRuby.WeatherMaker
{
    ...
    public class LightningCustomTransformStateInfo
    {
        ...
        /// </summary>
        /// <param name="info">LightningCustomTransformStateInfo</param>
    ...
    public class LightningLightParameters
    {
        ...
        /// <summary>Light position, zero if auto</summary>
    ...
    {
        internal static int lightningBoltCount;
        ...
        public class LineRendererMesh
        {
            ...
            /// </summary>
            /// <param name="lineCount">Max line count</param>
            /// <returns>True if success, false if full</returns>
            ...
            /// <param name="glowWidthModifier">Glow width multiplier</param>
...
// Unity 4.X does not support glow or fade or elapsed time
        ...
        public void SetupLightningBolt(LightningBoltDependencies dependencies)
        {
            ...
            timeSinceLevelLoad = WeatherMakerLightningBoltScript.TimeSinceStart;
        ...
        /// Update
        /// </summary>
        /// <returns>True if still alive, false if expired</returns>
        public bool Update()
        {
            elapsedTime += WeatherMakerLightningBoltScript.DeltaTime;
        ...
        /// </summary>
        /// <returns>Lightning bolt segment group</returns>
        ...
        private static IEnumerator NotifyBolt(LightningBoltDependencies dependencies, LightningBoltParameters p, Transform transform, Vector3 start, Vector3 end)
        {
            ...
            else
            {
                ...
                {
                    p.CustomTransform(state);
                    lifeTime -= WeatherMakerLightningBoltScript.DeltaTime;
                    yield return null;
                }
            }
            ...
            int nthLight, int nthShadows, ref int maxLights, ref int nthShadowCounter)
        {
            ...
            else if (lp.LightPosition == Vector3.zero)
            {
                pos = (group.Segments[segmentIndex].Start + group.Segments[segmentIndex].End) * 0.5f;
            }
            else
        ...
        private IEnumerator GenerateParticleCoRoutine(ParticleSystem p, Vector3 pos, float delay)
        {
            ...
            if (p.emission.burstCount > 0)
            {
                ...
                count = WeatherMakerRandomizer.Unity.Random(bursts[0].minCount, bursts[0].maxCount + 1);
                p.Emit(count);
            }
            else
            {
                ...
                count = WeatherMakerRandomizer.Unity.Random(count, count * 2);
                p.Emit(count);
            }
