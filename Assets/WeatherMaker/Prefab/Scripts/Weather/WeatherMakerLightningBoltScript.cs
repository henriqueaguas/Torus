    ...
    public class WeatherMakerLightningBoltScript : MonoBehaviour
    {
        ...
        private void SetMaterialPerspective()
        {
            if (calculatedCameraMode != CameraMode.Perspective)
            {
                ...
                lightningMaterialMeshInternal.SetInt("_LightningCameraMode", 1);
                lightningMaterialMeshNoGlowInternal.SetInt("_LightningCameraMode", 1);
            }
        }
        ...
        private void SetMaterialOrthographicXY()
        {
            if (calculatedCameraMode != CameraMode.OrthographicXY)
            {
                ...
                lightningMaterialMeshInternal.SetInt("_LightningCameraMode", 2);
                lightningMaterialMeshNoGlowInternal.SetInt("_LightningCameraMode", 2);
            }
        }
        ...
        private void SetMaterialOrthographicXZ()
        {
            if (calculatedCameraMode != CameraMode.OrthographicXZ)
            {
                ...
                lightningMaterialMeshInternal.SetInt("_LightningCameraMode", 3);
                lightningMaterialMeshNoGlowInternal.SetInt("_LightningCameraMode", 3);
            }
        }
        ...
        private void UpdateShaderParameters()
        {
            ...
            if (IntensityFlicker != intensityFlickerDefault && IntensityFlickerTexture != null)
            {
                ...
                lightningMaterialMeshInternal.SetInt("_LightningIntensityFlicker", 1);
                lightningMaterialMeshNoGlowInternal.SetInt("_LightningIntensityFlicker", 1);
            }
            else
            {
                lightningMaterialMeshInternal.SetInt("_LightningIntensityFlicker", 0);
                lightningMaterialMeshNoGlowInternal.SetInt("_LightningIntensityFlicker", 0);
            }
            SetupMaterialCamera();
        }
    ...
    public class WaitForSecondsLightning : CustomYieldInstruction
    {
        ...
        public override bool keepWaiting
        {
            get
            {
                ...
                remaining -= WeatherMakerLightningBoltScript.DeltaTime;
                return true;
            }
        }
    }
