...
namespace DigitalRuby.WeatherMaker
{
    ...
    public abstract class WeatherMakerLightningBoltPrefabScriptBase : WeatherMakerLightningBoltScript
    {
        ...
        /// <summary>How long to wait before creating another round of lightning bolts in seconds</summary>
        ...
        /// <summary>The trunk width range in unity units (x = min, y = max)</summary>
        ...
        /// <summary>
        /// Fill in lightning bolt parameters
        /// </summary>
        ...
        protected override void Update()
        {
            ...
            if ((lifeTimeRemaining -= WeatherMakerLightningBoltScript.DeltaTime) < 0.0f)
            {
                GameObject.Destroy(gameObject);
            }
            if ((nextLightningTimestamp -= WeatherMakerLightningBoltScript.DeltaTime) <= 0.0f)
            {
            ...
            {
                AutomaticModeSeconds = Mathf.Max(0.0f, AutomaticModeSeconds - WeatherMakerLightningBoltScript.DeltaTime);
    ...
    public class WeatherMakerLightningBoltPrefabScript : WeatherMakerLightningBoltPrefabScriptBase
    {
        ...
        /// </summary>
        /// <param name="parameters">Lightning bolt parameters</param>
