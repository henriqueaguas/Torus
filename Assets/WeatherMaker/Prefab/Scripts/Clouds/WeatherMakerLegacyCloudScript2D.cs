...
namespace DigitalRuby.WeatherMaker
{
    ...
    {
        /// <summary>Material for the clouds</summary>
        [Header("Rendering")]
        ...
        /// <summary>The total number of clouds to create</summary>
        [Header("Count")]
        [Range(0, 16250)]
